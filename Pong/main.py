...
# Function to play the song in a loop
def play_song(file_path):
    ...
    while True:
        song.play()
        pygame.time.wait(int(song.get_length() * 1000))

sound2=pygame.mixer.Sound("funk-upbeat-157134.mp3")
thread = threading.Thread(target=play_song, args=(sound2,))
thread.daemon = True
thread.start()
...
imgBackground = cv2.imread('org resources/image-1280x720 (1).png')
imgGameOver = cv2.imread('Resources/gameOver.png')
imgGameStart = cv2.imread('Resources/gameStart.png')
imgBall = cv2.imread('org resources/org ball.png', cv2.IMREAD_UNCHANGED)
...
sound= pygame.mixer.Sound('mixkit-soap-bubble-sound-2925.wav')
